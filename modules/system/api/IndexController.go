...
// 后台框架欢迎页面
func (w *IndexController) Main(c *gin.Context) {
	util.BuildTpl(c, "main").WriteTpl()
}

// 下载 public/upload 文件头像之类
func (w *IndexController) Download(c *gin.Context) {
...
// 切换皮肤
func (w *IndexController) SwitchSkin(c *gin.Context) {
	util.BuildTpl(c, "skin").WriteTpl()
}

// 注销
func (w *IndexController) Logout(c *gin.Context) {
